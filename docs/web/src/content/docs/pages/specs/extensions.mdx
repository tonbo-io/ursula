...
This document defines extensions to the [Durable Streams Protocol](/docs/specs/durable-stream). It adds bucket namespacing, snapshot and bootstrap semantics, multipart bootstrap delivery, mutable stream attributes, and Ursula-specific append batching for high-throughput small-event writes.
...
6. [Ordinary SSE Compatibility](#6-ordinary-sse-compatibility)
7. [URL Encoding](#7-url-encoding)
...
- `410 Gone`: The stream was soft-deleted.
