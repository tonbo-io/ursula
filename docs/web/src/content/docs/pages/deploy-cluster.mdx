...
Use `scripts/ursula_ec2.py` for the SSH/AWS-side plumbing: pushing binaries, writing systemd units, EC2 Instance Connect, S3 cleanup. See [operations](/docs/operations) for the full split.
