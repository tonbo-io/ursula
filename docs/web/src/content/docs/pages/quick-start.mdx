...
> Prefer containers? `docker run --rm -p 4437:4437 ghcr.io/tonbo-io/ursula:0.2.0` starts the same single node. See [Install](/docs/install). This page uses a source build.
