...
The range-aware manifest is format version 4. Version 2 single-source indexes are not adopted automatically; register the source in a new pool root and rebuild from Ursula. This is an intentional prototype-phase format break.
